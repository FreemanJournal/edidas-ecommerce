...
export default function SingleOrder({item,removeItemHandler}) {
    ...
    const { id, name, price, img, shipping, total,quantity } = item
    return (
        <Stack className="p-2 mx-3 bg-light singleOrder" gap={3} direction='horizontal'>
            ...
            <div className="delIcon ms-auto mb-auto text-danger" role="button" onClick={()=>removeItemHandler(id)}> <FaTrash title='Delete this item'/></div>
